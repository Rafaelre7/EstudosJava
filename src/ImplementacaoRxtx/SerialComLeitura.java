...
public class SerialComLeitura implements Runnable, SerialPortEventListener {
	...
	// O método abaixo irá habilitar a leitura da porta serial
	...
	public void serialEvent(SerialPortEvent ev) {
		// O método abstrato serialEvent() vai gerenciar todos os dados recebidos pela
		// serial, note que o nosso maior interesse é no evento
		// DATA_AVAILABLE que irá dizer se tem informação disponível para a leitura na
		// serial.
