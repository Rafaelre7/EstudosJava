...
public class BarChartDemo5 extends ApplicationFrame {
	...
	private static JFreeChart createChart(CategoryDataset dataset) {
		// create the chart...
		JFreeChart chart = ChartFactory.createBarChart("Prison Population Rates - Selected Countries", // chart title
		...
		renderer.setBaseToolTipGenerator(
				new StandardCategoryToolTipGenerator("{0}, {1}) = {2} per 100,000", new DecimalFormat("0")));
	...
	public static void main(String[] args) {
		BarChartDemo5 demo = new BarChartDemo5("JFreeChart: BarChartDemo5.java");
		demo.pack();
